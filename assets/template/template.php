...
<html>
  <head>
    ...
    <link rel="stylesheet" href="https://hrbid.azurewebsites.net/assets/css/style.css" />
    <link rel='icon' href='https://hrbid.azurewebsites.net/assets/img/favicon.ico' type='image/x-icon'/ >
    <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.4.1/jquery.min.js"></script>
    <script src="https://hrbid.azurewebsites.net/assets/js/global.js"></script>
  </head>
